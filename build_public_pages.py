...
BIZ = _client.get('name') or manifest.get('businessName', 'AE Optimizer')
WEBSITE = _client.get('canonicalUrl') or manifest.get('canonicalUrl', '') or manifest.get('websiteUrl', 'https://ai.aeoptimizer.com')
...
VERTICAL = (_client.get('vertical') or manifest.get('vertical') or 'other').lower()
PAGES_URL = (_client.get('pagesUrl') or manifest.get('pagesUrl') or 'https://AIOVisibilityHub.github.io/ae-optimizer-ai-schemas-kj9q/') or (WEBSITE or '')
